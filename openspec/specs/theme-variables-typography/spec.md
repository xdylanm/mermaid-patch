# Spec: Theme Variables — Typography

## Purpose

Defines how the `themeVariables.fontFamily` and `themeVariables.fontSize` Mermaid config keys are consumed by the renderer to control text styling across all SVG text elements.
