# Spec: Compact Diagram Spacing

## Purpose

Defines the spacing constants that control whitespace around and between nodes in the rendered SVG diagram. These constants are used by the layout engine to configure ELK padding and the SVG viewBox computation.
